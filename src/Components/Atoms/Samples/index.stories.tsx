...
storiesOf("Atoms/StyledButton", module).add("default", () => (
  <StyledButton>Hello world!</StyledButton>
));
storiesOf("Atoms/StyledH1WithTheme", module).add("default", () => (
  <ThemeProvider theme={theme}>
    <StyledH1WithTheme>H1 is here!</StyledH1WithTheme>
  </ThemeProvider>
));
storiesOf("Atoms/StyledH1WithProps", module).add("default", () => (
  <StyledH1WithProps color="green">H1 is here!</StyledH1WithProps>
));

storiesOf("Atoms/StyledH1Switchable", module).add("default(active)", () => (
  <ThemeProvider theme={theme}>
    <StyledH1Switchable isActive={true}>H1 is here!</StyledH1Switchable>
  </ThemeProvider>
));
storiesOf("Atoms/StyledH1Switchable", module).add("inActive", () => (
  <ThemeProvider theme={theme}>
    <StyledH1Switchable isActive={false}>H1 is here!</StyledH1Switchable>
  </ThemeProvider>
));

storiesOf("Atoms/StyledH1WithPropsSfc", module).add("default", () => (
  <StyledH1WithPropsSfc>StyledH1WithPropsSfc is here!</StyledH1WithPropsSfc>
));
storiesOf("Atoms/StyledH1WithPropsSfc", module).add("prop1: true", () => (
  <StyledH1WithPropsSfc prop1={true}>
    StyledH1WithPropsSfc is here!
  </StyledH1WithPropsSfc>
));
storiesOf("Atoms/StyledH1WithPropsSfc", module).add(
